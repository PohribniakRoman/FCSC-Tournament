...
const StandingsData = [
  ...
  { name: "Пивний удар", scroe: { wins: 1, loses: 0 } },
  { name: "Sniffers", scroe: { wins: 0, loses: 0 } },
  { name: "Team Bobr", scroe: { wins: 1, loses: 1 } },
...
const ScheduleData = [
  ...
  },
  {
    date: 29.07,
    time: "16:00",
    participants: [StandingsData[3], StandingsData[0]],
    completed: true,
    score: [1, 0],
  },
  {
    date: 29.07,
    time: "17:00",
    participants: [StandingsData[5], StandingsData[2]],
    completed: true,
    score: [1, 0],
  },
  {
    date: 29.07,
    time: "17:00",
    participants: [StandingsData[1], StandingsData[6]],
    completed: true,
    score: [1, 0],
  },
  {
  ...
  },
  {
    date: 29.07,
    time: "19:30",
    participants: [StandingsData[5], StandingsData[1]],
    completed: false,
    score: [0, 0],
  },
];
